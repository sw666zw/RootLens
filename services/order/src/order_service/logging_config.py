"""Structured logging configuration for the Order Service."""
...
DEFAULT_LOG_FILE_PATH = Path("runtime/logs/order.jsonl")
_CONSOLE_HANDLER_MARKER = "_order_json_console_handler"
_FILE_HANDLER_MARKER = "_order_json_file_handler"
_STRUCTURED_FIELDS = (
    "request_id",
    "method",
    "path",
...
class FileLoggingSettings:
    """Settings for optional JSON-lines output."""
...
class JsonFormatter(logging.Formatter):
    """Format Order Service logs as one JSON object per line."""
...
class JsonLinesFileHandler(logging.FileHandler):
    """Make appended JSON lines promptly visible to the host-mounted collector."""
